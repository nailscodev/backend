...
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a001', 'Gel Removal - Mani (No Service)', 'Gentle and safe gel polish removal when no other service is booked. Leaves nails clean and ready to breathe. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.', 'ADDON', 'c6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'c1a2b3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 20, 15, 10, true, false, 28, false),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a002', 'Gel Removal - Pedi (No Service)', 'Gentle and safe gel polish removal when no other service is booked. Leaves nails clean and ready to breathe. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.', 'ADDON', 'c6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', 20, 15, 10, true, false, 29, false),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a003', 'Extensions or Acrylics Removal', 'Gentle and safe hard gel, extensions or acrylic removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.', 'ADDON', 'c6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'c1a2b3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 20, 25, 10, true, false, 30, false),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a004', 'Builder Gel / BIAB Removal - Mani (No Service)', 'Gentle and safe Builder Gel / BIAB removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.', 'ADDON', 'c6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'c1a2b3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 15, 15, 10, true, false, 31, false),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a005', 'Builder Gel / BIAB Removal - Pedi (No Service)', 'Gentle and safe Builder Gel / BIAB removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.', 'ADDON', 'c6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', 15, 15, 10, true, false, 32, false);
...
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a401', 'Additional Gel Polish Service', 'Long-lasting gel polish of your choice from our color collection.', 20, 30, true, 10, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a402', 'French Design', 'Elevate your look with a classic French tip.', 10, 15, true, 20, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a403', 'Cat Eye Finish', 'Unique magnetic gel polish creates a cat eye effect for a stunning, reflective finish.', 25, 20, true, 23, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a404', 'Chrome Finish', 'A mirror-like chrome layer for a reflective, metallic look - inspired by the Glazed Donut manicure trend.', 10, 20, true, 26, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a405', 'Nail Art (10 M)', 'Simple design for a quick, elegant look.', 10, 10, true, 30, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a406', 'Nail Art (15 M)', 'Medium complexity design with added detail.', 15, 15, true, 33, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a407', 'Nail Art (20 M)', 'Elaborate design with extra detail.', 25, 20, true, 36, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a408', 'Extended Massage', 'Extend your treatment with 10 more minutes of relaxing massage.', 15, 10, true, 40, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a409', 'Fix Nail', 'Repair one damaged or broken nail using the same overlay system (gel, capping).', 5, 15, true, 50, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a410', 'Fix Nail Extension', 'Rebuild one broken or lifted nail using matching material and finish (Acrylic, Polygel, Gel-X).', 10, 20, true, 51, false),
-- Add-ons específicos para combos (Mani/Pedi separados)
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a411', 'French Design - Mani', 'Elevate your look with a classic French tip.', 10, 15, true, 21, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a412', 'French Design - Pedi', 'Elevate your look with a classic French tip.', 10, 15, true, 22, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a413', 'Nail Art (10 M) - Mani', 'Simple design for a quick, elegant look.', 10, 10, true, 31, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a414', 'Nail Art (10 M) - Pedi', 'Simple design for a quick, elegant look.', 10, 10, true, 32, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a415', 'Nail Art (15 M) - Mani', 'Medium complexity design with added detail.', 15, 15, true, 34, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a416', 'Nail Art (15 M) - Pedi', 'Medium complexity design with added detail.', 15, 15, true, 35, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a417', 'Nail Art (20 M) - Mani', 'Elaborate design with extra detail.', 25, 20, true, 37, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a418', 'Nail Art (20 M) - Pedi', 'Elaborate design with extra detail.', 25, 20, true, 38, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a419', 'Extended Massage - Mani', 'Extend your treatment with 10 more minutes of relaxing massage.', 15, 10, true, 41, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a420', 'Extended Massage - Pedi', 'Extend your treatment with 10 more minutes of relaxing massage.', 15, 10, true, 42, false),
-- Removal add-ons (removal = true) - Converted from services
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a421', 'Gel Removal - Mani', 'Gentle gel polish removal for manicure. Leaves nails clean and ready.', 10, 15, true, 60, true),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a422', 'Gel Removal - Pedi', 'Gentle gel polish removal for pedicure. Leaves nails clean and ready.', 10, 15, true, 61, true),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a423', 'Extensions or Acrylics Removal', 'Safe removal of acrylics or nail extensions.', 20, 25, true, 62, true),
-- New add-ons for Nail Enhancements
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a424', 'Acrylic With Tips M', 'Medium-length acrylic extension upgrade.', 10, 10, true, 11, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a425', 'Acrylic With Tips L', 'Long-length acrylic extension upgrade.', 20, 10, true, 12, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a426', '+3 Weeks Refill', 'For moderate regrowth.', 10, 0, true, 13, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a427', '+4 Weeks Refill', 'For extended regrowth.', 20, 0, true, 14, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a428', 'Polygel With Tips M', 'Medium-length Polygel extension upgrade.', 10, 20, true, 15, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a429', 'Polygel With Tips L', 'Long-length Polygel extension upgrade.', 20, 20, true, 16, false),
-- Combo-specific Cat Eye and Chrome (Mani/Pedi variants)
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a430', 'Cat Eye Finish - Mani', 'Unique magnetic gel polish creates a "cat eye" effect for a stunning, reflective finish.', 25, 20, true, 24, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a431', 'Cat Eye Finish - Pedi', 'Unique magnetic gel polish creates a "cat eye" effect for a stunning, reflective finish.', 25, 20, true, 25, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a432', 'Chrome Finish - Mani', 'A mirror-like chrome layer for a reflective, metallic look - inspired by the Glazed Donut manicure trend.', 10, 20, true, 27, false),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a433', 'Chrome Finish - Pedi', 'A mirror-like chrome layer for a reflective, metallic look - inspired by the Glazed Donut manicure trend.', 10, 20, true, 28, false),
-- Builder Gel / BIAB Removal add-ons
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a434', 'Builder Gel / BIAB Removal - Mani', 'Safe removal of builder gel or BIAB for manicure. Leaves nails clean and ready.', 15, 15, true, 63, true),
('10a1b2c3-d4e5-46f7-a8b9-c0d1e2f3a435', 'Builder Gel / BIAB Removal - Pedi', 'Safe removal of builder gel or BIAB for pedicure. Leaves nails clean and ready.', 15, 15, true, 64, true);
...
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a001', '00000000-0000-0000-0000-000000000001', 'Gel Removal - Mani (No Service)', 'Gentle and safe gel polish removal when no other service is booked. Leaves nails clean and ready to breathe. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.'),
...
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a002', '00000000-0000-0000-0000-000000000001', 'Gel Removal - Pedi (No Service)', 'Gentle and safe gel polish removal when no other service is booked. Leaves nails clean and ready to breathe. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.'),
...
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a003', '00000000-0000-0000-0000-000000000001', 'Extensions or Acrylics Removal', 'Gentle and safe hard gel, extensions or acrylic removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.'),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a003', '00000000-0000-0000-0000-000000000002', 'Retiro de Extensiones o Acrílicos', 'Retiro suave y seguro de acrílico o extensiones para cuando no se reserva otro servicio. ¿Vas a reservar una mani o pedi? Seleccione el servicio principal y agregue el retiro como complemento.'),
-- Builder Gel / BIAB Removal - Mani (No Service)
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a004', '00000000-0000-0000-0000-000000000001', 'Builder Gel / BIAB Removal - Mani (No Service)', 'Gentle and safe Builder Gel / BIAB removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.'),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a004', '00000000-0000-0000-0000-000000000002', 'Retiro de Builder Gel / BIAB - Mani (sin servicio)', 'Retiro suave y seguro de extensiones Builder Gel / BIAB para cuando no se reserva otro servicio. ¿Vas a reservar una mani o pedi? Seleccione el servicio principal y agregue el retiro como complemento.'),
-- Builder Gel / BIAB Removal - Pedi (No Service)
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a005', '00000000-0000-0000-0000-000000000001', 'Builder Gel / BIAB Removal - Pedi (No Service)', 'Gentle and safe Builder Gel / BIAB removal when no other service is booked. Booking a new mani or pedi? Please select the main service and add removal as an add-on instead.'),
('f6a7b8c9-d0e1-42f3-a4b5-c6d7e8f9a005', '00000000-0000-0000-0000-000000000002', 'Retiro de Builder Gel / BIAB - Pedi (sin servicio)', 'Retiro suave y seguro de extensiones Builder Gel / BIAB para cuando no se reserva otro servicio. ¿Vas a reservar una mani o pedi? Seleccione el servicio principal y agregue el retiro como complemento.');
